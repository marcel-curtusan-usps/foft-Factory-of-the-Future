...
namespace Factory_of_the_Future
{
    public class System_Information
    {
        ...
        private static readonly ManagementObjectSearcher computersystemSearcher = new ManagementObjectSearcher("root\\CIMV2", "SELECT * FROM Win32_ComputerSystemProduct");
        ...
        private static string ConvertToDateTime(string unconvertedTime)
        {
            ...
            string convertedTime = date.ToString() + "/" + month.ToString() + "/" + year.ToString() + " " +
